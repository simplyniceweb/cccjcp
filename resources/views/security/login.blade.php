<form class="block sm:grid sm:grid-rows-4 gap-y-2" action="{{ route('login.authenticate') }}" method="POST">
    ...
    <button type="button" class="mt-3 sm:mt-0 w-full h-10 bg-red-500 hover:bg-red-700 text-center rounded font-semibold text-white text-sm">CHANGE PASSWORD?</button>
</form>