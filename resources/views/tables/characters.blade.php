...
<table class="mb-3 mt-3 w-full border-collapse border border-slate-400">
    <thead class="text-left">
        <tr>
            <th class="hidden sm:inherit border border-slate-300 p-2"></th>
            <th class="border border-slate-300 p-2">ID</th>
            <th class="border border-slate-300 p-2">Name</th>
            <th class="hidden sm:inherit border border-slate-300 p-2">Sex</th>
            ...
            <th class="hidden sm:inherit border border-slate-300 p-2">Last Log</th>
    ...
    <tbody>
        ...
        <tr>
            <td class="hidden sm:inherit border border-slate-300 p-2"><img src="https://ratemyserver.net/skill_chars/j{{$user->class}}_{{ strtolower($user->sex) }}_stand.gif" class="w-9" alt=""></td>
            <td class="border border-slate-300 p-2">{{ $user->char_id }}</td>
            <td class="border border-slate-300 p-2">{{ $user->name ?: 'n/a' }}</td>
            <td class="hidden sm:inherit border border-slate-300 p-2">{{ $user->sex ?: 'n/a' }}</td>
            ...
            <td class="hidden sm:inherit border border-slate-300 p-2">{{ $user->last_login ?: 'n/a' }}</td>
