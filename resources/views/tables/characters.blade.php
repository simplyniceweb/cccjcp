    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border border-slate-300 p-2">
                <a onClick="return confirm('Are you sure want to reset character position?')" href="{{ route('reset.position', $user->char_id) }}" class="bg-red-400 px-1 font-semibold uppercase rounded text-white">Reset Position?</button>
            </td>
        </tr>
        @endforeach
    </tbody>
