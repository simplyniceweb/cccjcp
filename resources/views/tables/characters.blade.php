...
<table class="mb-3 mt-3 w-full border-collapse border border-slate-400 overflow-x-scroll sm:overflow-auto">
    ...
    <tbody>
        ...
        <tr class="flex flex-col flex-no wrap sm:table-row">
            ...
            <td class="border border-slate-300 p-2 text-right sm:text-left"><span class="inline-block font-semibold sm:hidden mr-2 uppercase">ID:</span>{{ $user->char_id }}</td>
            <td class="border border-slate-300 p-2 text-right sm:text-left"><span class="inline-block font-semibold sm:hidden mr-2 uppercase">Name:</span>{{ $user->name ?: 'n/a' }}</td>
            <td class="border border-slate-300 p-2 text-right sm:text-left"><span class="inline-block font-semibold sm:hidden mr-2 uppercase">Sex:</span>{{ $user->sex ?: 'n/a' }}</td>
            <td class="border border-slate-300 p-2 text-right sm:text-left"><span class="inline-block font-semibold sm:hidden mr-2 uppercase">Class:</span>{{ $user->class ?: 'n/a' }}</td>
            <td class="border border-slate-300 p-2 text-right sm:text-left"><span class="inline-block font-semibold sm:hidden mr-2 uppercase">Base Lvl:</span>{{ $user->base_level ?: 'n/a' }}</td>
            <td class="border border-slate-300 p-2 text-right sm:text-left"><span class="inline-block font-semibold sm:hidden mr-2 uppercase">Job Lvl:</span>{{ $user->job_level ?: 'n/a' }}</td>
            <td class="border border-slate-300 p-2 text-right sm:text-left"><span class="inline-block font-semibold sm:hidden mr-2 uppercase">Last Log:</span>{{ $user->last_login ?: 'n/a' }}</td>
